...
$this->sections[] = array(
  ...
  'desc' => esc_html__('Check child sections to style properly the correct area of the theme.', 'videoly'),
  'icon' => 'el-icon-cog',
  'fields' => array(
...
$this->sections[] = array(
  ...
  'desc' => esc_html__('Configure heading styles.', 'videoly'),
  'subsection' => true,
  'fields' => array(
    array(
      'id' => 'font-heading',
      ...
      .tt-blog-nav-title,.tt-comment-label,.tt-search input[type="text"],.tt-share-title,.tt-heading-title,.tt-mblock-label'),
    ),
  ),
);
...
$this->sections[] = array(
  ...
  'desc' => esc_html__('Configure body styles.', 'videoly'),
  'subsection' => true,
  'fields' => array(
    array(
      'id' => 'font-body',
