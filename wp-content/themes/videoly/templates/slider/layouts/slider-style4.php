...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <div class="slider-style4 full-width">
        <!-- <div class="row row-14"> -->
          ...
          <!-- <div class="col-lg-8"> -->
            ...
            <div class="slider-style4-frame">
              <div class="tt-mslide type-2 <?php echo esc_attr($class); ?> style-2" style="background-image:url(<?php echo esc_url($image_src); ?>);">
                ...
                <div class="tt-mslide-table">
                  <div class="tt-mslide-cell">
                    <div class="tt-mslide-block">
                      ...
                      <h2 class="tt-mslide-title <?php echo esc_attr($heading_class); ?>"><a href="<?php echo esc_url(get_the_permalink()); ?>"><?php the_title(); ?></a></h2>
